...
#define BCM_CORE_CLK_LOW	(208U*1000)
#define BCM_CORE_CLK_NORMALMH	(416U*1000)
//#define BCM_CORE_CLK_SNAILS	(104U*1000)
...
//	FTBL_INIT(BCM_CORE_CLK_SNAILS / 1000, 1120000),
	FTBL_INIT(BCM_CORE_CLK_LOW / 1000, 1120000),
	FTBL_INIT(BCM_CORE_CLK_NORMAL / 1000, 1160000),
	FTBL_INIT(BCM_CORE_CLK_NORMALMH / 1000, 1200000),
	FTBL_INIT(BCM_CORE_CLK_NORMALH / 1000, 1220000),
	FTBL_INIT(BCM_CORE_CLK_TURBOL / 1000, 1260000),
//	FTBL_INIT(BCM_CORE_CLK_TURBOM / 1000, 1300000),
	FTBL_INIT(BCM_CORECLK_TURBO / 1000, 134000),
...
#define NM2_FF_VOLTAGE_LOW	1110000
#define NM2_TT_VOLTAGE_LOW	1120000
#define NM2_SS_VOLTAGE_LOW	1140000

#define NM2_FF_VOLTAGE_NORMAL	1140000
#define NM2_TT_VOLTAGE_NORMAL	1160000
#define NM2_SS_VOLTAGE_NORMAL	1180000

#define NM2_FF_VOLTAGE_NORMALMH	1180000
#define NM2_TT_VOLTAGE_NORMALMH	1200000
#define NM2_SS_VOLTAGE_NORMALMH	1220000

#define NM2_FF_VOLTAGE_NORMALH	1220000
#define NM2_TT_VOLTAGE_NORMALH	1240000
#define NM2_SS_VOLTAGE_NORMALH	1260000

#define NM2_FF_VOLTAGE_TURBOL	1260000
#define NM2_TT_VOLTAGE_TURBOL	1280000
...
//	if (normal >= 0)
	{
//		bcm215xx_cpu0_freq_tbl[BCM_SNAILS_MODE].cpu_voltage =
//			1120000;
		bcm215xx_cpu0_freq_tbl[BCM_NORMAL_MODE].cpu_voltage =
			(u32)normal;
		bcm215xx_cpu0_freq_tbl[BCM_NORMALH_MODE].cpu_voltage =
			1240000;
//	}
//	if (turbo >= 0)
